...
const Edit_img = ({
  ...
  return (
    <>
      <div className="w-full  absolute   flex-col top-0 left-0 h-full flex justify-center items-end md:p-[0.5vw] md:gap-[1.5vw] capitalize bg-black bg-opacity-[30%] z-[20] md:text-[1vw] p-[5vw] text-[3.5vw] gap-[5vw]">
        <button
