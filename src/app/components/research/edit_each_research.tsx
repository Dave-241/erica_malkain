...
const Edit_each_research = ({ setopen_edit, id, setedit_ID }: any) => {
  ...
  return (
    <>
      <div className="w-full md:border-white md:border  absolute  flex-col top-0 left-0 h-full flex justify-center items-end md:p-[0.5vw] md:gap-[1.5vw] capitalize bg-black bg-opacity-[30%] z-[60] md:text-[1.5vw] p-[5vw] leading-normal text-[3.5vw] gap-[5vw]">
        <button
...
export default Edit_each_research;
