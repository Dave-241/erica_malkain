...
import { Helvetica_medium, spline_font } from "@/app/utils/fonts";
...
const AnimatedLines: React.FC = () => {
  ...
  // THIS IS  FOR THE DESKTOP  , I WOULD BUILD THAT OF MOBILE
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div
        className={`  w-full md:px-[10vw] ${Helvetica_medium.className} md:text-[1.1vw] text-[4vw] flex-col md:flex-row gap-[5vw] px-[3%] py-[8vw]  md:pb-0 md:pt-[4vw] text-[#000000] flex md:gap-[10%] `}
      >
        <p className="">
          Erica Boothby is a psychologist who studies social connection and the
          psychological barriers that inhibit connection. Feeling socially
          disconnected or excluded has many detrimental effects—making employees
          feel alienated, managers feel burned out,{" "}
        </p>

        <p className="">
          and people from underrepresented groups feel like their voices arent
          heard. Ericas research aims to illuminate what makes people feel more
          (or less) connected, and what we can do to improve peoples feelings of
      ...
      >
        <div className="w-full hidden  h-[100vh] md:flex justify-center items-center sticky top-0 left-0 ">
          <svg
          ...
          >
            ...
            <foreignObject x="0" y="0" width="100%" height="100%">
              <div
                className="h-full flex overflow-hidden   b"
                // style={{ width: `${100}%`, transition: "6s ease" }}
              >
                <div
                  className="w-[40%] flex justify-end  overflow-hidden"
        ...
        <div className="w-full md:hidden  h-[100vh] flex justify-center items-center sticky top-0 left-0 ">
          <svg
            ...
            preserveAspectRatio="xMinYMin meet"
            fill="none"
            className="w-auto h-[80vh] absolute top-[50%] left-[50%] translate-x-[-25%] translate-y-[-50%] "
          >
            <path
            ...
            <foreignObject x="0" y="0" width="100%" height="100%">
              ...
              >
                <div
                  className="h-[40%]  flex items-end  overflow-hidden"
                  // style={{ width: `${width}%`, transition: "6s ease" }}
                >
                  <div
      ...
      >
        ...
        <p className="">
          ...
          outlets such as Harvard Business Review, The New York Times, National
          Public Radio, and The Washington Post. Her work was recently covered
          extensively on NPRs Hidden Brain.
        </p>
      </div>
    </>
  );
